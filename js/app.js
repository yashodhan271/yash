! function(t, e) {
    ...
    return function(t) {
                ...
                return function t(e, n, r) {
                    ...
                    2: [function(t, n, r) {
                        ...
                        a.prototype.setScheduler = function(t) {
                            ...
                            this._isTickUsed = !1
                        }, n.exports = a, n.exports.firstLineError = i
                    }, {
                        "./queue": 26,
                        "./schedule": 29
                    }],
                    ...
                    9: [function(t, n, r) {
                        "use strict";
                        n.exports = function(n, r, i, o) {
                            var s, a, c, l, u = n._async,
                                f = t("./errors").Warning,
                                p = t("./util"),
                                h = t("./es5"),
                                d = p.canAttachTrace,
                                ...
                                _ = null,
                                b = !1,
                                w = !(0 == p.env("BLUEBIRD_DEBUG")),
                                k = !(0 == p.env("BLUEBIRD_WARNINGS") || !w && !p.env("BLUEBIRD_WARNINGS")),
                                E = !(0 == p.env("BLUEBIRD_LONG_STACK_TRACES") || !w && !p.env("BLUEBIRD_LONG_STACK_TRACES")),
                                C = 0 != p.env("BLUEBIRD_W_FORGOTTEN_RETURN") && (k || !!p.env("BLUEBIRD_W_FORGOTTEN_RETURN"));
                            ! function() {
                                var t = [];
                                ...
                                l = function(n) {
                                    t.push(n), setTimeout(e, 1)
                                }, h.defineProperty(n, "_unhandledRejectionCheck", {
                                    value: e
                                }), h.defineProperty(n, "_unhandledRejectionClear", {
                                    value: r
                                })
                                ...
                                q("rejectionHandled", s, void 0, this)
                                ...
                                if (this._isRejectionUnhandled()) {
                                    ...
                                    this._setUnhandledRejectionIsNotified(), q("unhandledRejection", a, t, this)
                                }
                            ...
                            n.longStackTraces = function() {
                                if (u.haveItemsQueued() && !nt.longStackTraces) throw new Error("cannot enable long stack traces after promises have been created\n\n    See https://goo.gl/MqrFmX\n");
                                if (!nt.longStackTraces && W()) {
                                    var t = n.prototype._captureStackTrace,
                                        e = n.prototype._attachExtraTrace,
                                        i = n.prototype._dereferenceTrace;
                                    nt.longStackTraces = !0, x = function() {
                                        if (u.haveItemsQueued() && !nt.longStackTraces) throw new Error("cannot enable long stack traces after promises have been created\n\n    See https://goo.gl/MqrFmX\n");
                                        n.prototype._captureStackTrace = t, n.prototype._attachExtraTrace = e, n.prototype._dereferenceTrace = i, r.deactivateLongStackTraces(), nt.longStackTraces = !1
                                    }, n.prototype._captureStackTrace = D, n.prototype._attachExtraTrace = V, n.prototype._dereferenceTrace = N, r.activateLongStackTraces()
                                }
                            }, n.hasLongStackTraces = function() {
                                return nt.longStackTraces && W()
                            };
                            var A = {
                                    unhandledrejection: {
                                        before: function() {
                                ...
                                j = function() {
                                    ...
                                    try {
                                        ...
                                        return "function" == typeof Event ? (e = new Event("CustomEvent"), p.global.dispatchEvent(e), function(e, n) {
                                            ...
                                            return r.initCustomEvent(e, !1, !0, n), t(A[e], r)
                                        })
                                    } catch (t) {}
                                    return function() {
                                        return !1
                            ...
                            n.config = function(t) {
                                if ("longStackTraces" in (t = Object(t)) && (t.longStackTraces ? n.longStackTraces() : !t.longStackTraces && n.hasLongStackTraces() && x()), "warnings" in t) {
                                    var e = t.warnings;
                                    nt.warnings = !!e, C = nt.warnings, p.isObject(e) && "wForgottenReturn" in e && (C = !!e.wForgottenReturn)
                                }
                                if ("cancellation" in t && t.cancellation && !nt.cancellation) {
                                    ...
                                    n.prototype._clearCancellationData = L, n.prototype._propagateFrom = H, n.prototype._onCancel = I, n.prototype._setOnCancel = M, n.prototype._attachCancellationCallback = B, n.prototype._execute = R, Q = H, nt.cancellation = !0
                                }
                                if ("monitoring" in t && (t.monitoring && !nt.monitoring ? (nt.monitoring = !0, n.prototype._fireEvent = O) : !t.monitoring && nt.monitoring && (nt.monitoring = !1, n.prototype._fireEvent = P)), "asyncHooks" in t && p.nodeSupportsAsyncResource) {
                                    var r = nt.asyncHooks,
                                        s = !!t.asyncHooks;
                                    r !== s && (nt.asyncHooks = s, s ? i() : o())
                                }
                                return n
                            }, n.prototype._fireEvent = P, n.prototype._execute = function(t, e, n) {
                                try {
                                    t(e, n)
                                } catch (t) {
                                    return t
                            ...
                            function D() {
                                this._trace = new tt(this._peekContext())
                            }
                            ...
                            function G(t, e, r) {
                                if (nt.warnings) {
                                    ...
                                    else if (nt.longStackTraces && (i = n._peekContext())) i.attachExtraTrace(o);
                                    else {
                                        var s = U(o);
                                        o.stack = s.message + "\n" + s.stack.join("\n")
                                    }
                            ...
                            function K(t, e, n) {
                                if ("undefined" != typeof console) {
                                    ...
                                    "function" == typeof c ? c(r, n) : "function" != typeof console.log && "object" != typeof console.log || console.log(r)
                                }
                            }
                            ...
                            function q(t, e, n, r) {
                                ...
                                "unhandledRejection" === t ? O(t, n, r) || i || K(n, "Unhandled rejection ") : O(t, r)
                            }
                            ...
                            p.inherits(tt, Error), r.CapturedTrace = tt, tt.prototype.uncycle = function() {
                                var t = this._length;
                                if (!(t < 2)) {
                            ...
                            }, tt.prototype.attachExtraTrace = function(t) {
                                if (!t.__stackCleaned__) {
                                    this.uncycle();
                                    for (var e = U(t), n = e.message, r = [e.stack], i = this; void 0 !== i;) r.push(J(i.stack.split("\n"))), i = i._parent;
                                    ! function(t) {
                            ...
                            var et = function() {
                                ...
                                var r, i = new Error;
                                if ("string" == typeof i.stack && i.stack.split("\n")[0].indexOf("stackDetection@") >= 0) return m = /@/, _ = e, b = !0,
                                    function(t) {
                                ...
                                return !("stack" in i) && r && "number" == typeof Error.stackTraceLimit ? (m = t, _ = e, function(t) {
                            ...
                            "undefined" != typeof console && void 0 !== console.warn && (c = function(t) {
                                console.warn(t)
                            ...
                            return E && n.longStackTraces(), {
                                ...
                                checkForgottenReturns: function(t, e, n, r, i) {
                                    if (void 0 === t && null !== e && C) {
                                        ...
                                        var h = "a promise was created in a " + n + "handler " + o + "but was not returned from it, see https://goo.gl/rRqMUw" + s;
                                        r._warn(h, !0, e)
                                    }
                                },
                                setBounds: function(t, e) {
                                    if (W()) {
                                        ...
                                        s < 0 || a < 0 || !n || !r || n !== r || s >= a || (Y = function(t) {
                    ...
                    18: [function(t, e, n) {
                        ...
                        e.exports = function(e, n, r, i, o, s) {
                            ...
                            function p(t, n, i, o) {
                                ...
                                return new f(t, n, s = "number" == typeof s && isFinite(s) && s >= 1 ? s : 0, o).promise()
                            }
                            a.inherits(f, n), f.prototype._asyncInit = function() {
                                this._init$(void 0, -2)
                            }, f.prototype._init = function() {}, f.prototype._promiseFulfilled = function(t, n) {
                                var r = this._values,
                                    o = this.length(),
                                ...
                                if (n < 0) {
                                    ...
                                    if (y instanceof e) {
                                        ...
                                        if (0 == (50397184 & g)) return u >= 1 && this._inFlight++, r[n] = y, y._proxy(this, -1 * (n + 1)), !1;
                    ...
                    22: [function(t, n, r) {
                        ...
                        n.exports = function() {
                            ...
                            var l = function() {
                                ...
                                f = c.isNode && c.nodeSupportsAsyncResource ? t("async_hooks").AsyncResource : null,
                                p = function() {
                                    return {
                                        domain: l(),
                                        async: new f("Bluebird::Promise")
                                    }
                                },
                                h = c.isNode ? u : function() {
                                    return null
                                };
                            c.notEnumerableProp(R, "_getContext", h);
                            var d = t("./es5"),
                                v = t("./async"),
                                y = new v;
                            ...
                            var b = function() {},
                                ...
                                k = {},
                                E = t("./thenables")(R, b),
                                C = t("./promise_array")(R, b, E, o, s),
                                x = t("./context")(R),
                                A = x.create,
                                j = t("./debuggability")(R, x, (function() {
                                    h = p, c.notEnumerableProp(R, "_getContext", p)
                                }), (function() {
                                    h = u, c.notEnumerableProp(R, "_getContext", u)
                                })),
                                F = (j.CapturedTrace, t("./finally")(R, E, k)),
                                T = t("./catch_filter")(k),
                                S = t("./nodeback"),
                                O = c.errorObj,
                                P = c.tryCatch;
                            ...
                            function R(t) {
                                t !== b && function(t, e) {
                                    if (null == t || t.constructor !== R) throw new m("the promise constructor cannot be invoked directly\n\n    See https://goo.gl/MqrFmX\n");
                                    if ("function" != typeof e) throw new m("expecting a function but got " + c.classString(e))
                            ...
                            return R.prototype.toString = function() {
                                ...
                                if (e > 1) {
                                    ...
                                    if (r.length = i, "function" != typeof(t = arguments[n])) throw new m("The last argument to .catch() must be a function, got " + c.toString(t));
                                ...
                                return "function" != typeof t ? o("expecting a function but got " + c.classString(t)) : this.all()._then(t, void 0, void 0, w, void 0)
                                ...
                                var e = E(t);
                                return e instanceof R || ((e = new R(b))._captureStackTrace(), e._setFulfilled(), e._rejectionHandler0 = t), e
                            }, R.resolve = R.fulfilled = R.cast, R.reject = R.rejected = function(t) {
                                var e = new R(b);
                                return e._captureStackTrace(), e._rejectCallback(t, !0), e
                            }, R.setScheduler = function(t) {
                                if ("function" != typeof t) throw new m("expecting a function but got " + c.classString(t));
                                ...
                                var o = void 0 !== i,
                                    ...
                                    a = this._target(),
                                    l = a._bitField;
                                o || (s._propagateFrom(this, 3), s._captureStackTrace(), void 0 === r && 0 != (2097152 & this._bitField) && (r = 0 != (50397184 & l) ? this._boundValue() : a === this ? void 0 : this._boundTo), this._fireEvent("promiseChained", this, s));
                                var u = h();
                                if (0 != (50397184 & l)) {
                                    var f, p, d = a._settlePromiseCtx;
                                    0 != (33554432 & l) ? (p = a._rejectionHandler0, f = t) : 0 != (16777216 & l) ? (p = a._fulfillmentHandler0, f = e, a._unsetRejectionIsUnhandled()) : (d = a._settlePromiseLateCancellationObserver, p = new _("late cancellation observer"), a._attachExtraTrace(p), f = e), y.invoke(d, a, {
                                        handler: c.contextBind(u, f),
                                        promise: s,
                                        receiver: r,
                                        value: p
                                    })
                                } else a._addCallbacks(t, e, s, r, u);
                                return s
                                ...
                                var o = this._length();
                                if (o >= 65531 && (o = 0, this._setLength(0)), 0 === o) this._promise0 = n, this._receiver0 = r, "function" == typeof t && (this._fulfillmentHandler0 = c.contextBind(i, t)), "function" == typeof e && (this._rejectionHandler0 = c.contextBind(i, e));
                                else {
                                    var s = 4 * o - 4;
                                    this[s + 2] = n, this[s + 3] = r, "function" == typeof t && (this[s + 0] = c.contextBind(i, t)), "function" == typeof e && (this[s + 1] = c.contextBind(i, e))
                                }
                                ...
                                if (0 == (65536 & i)) {
                                    var o;
                                    r._pushContext(), e === w ? n && "number" == typeof n.length ? o = P(t).apply(this._boundValue(), n) : (o = O).e = new m("cannot .spread() a non-array: " + c.classString(n)) : o = P(t).call(e, n);
                                    var s = r._popContext();
                                    0 == (65536 & (i = r._bitField)) && (o === k ? r._reject(n) : o === O ? r._rejectCallback(o.e, !1) : (j.checkForgottenReturns(o, s, "", r, this), r._resolveCallback(o)))
                                }
                            ...
                            }, R.prototype._settlePromise = function(t, e, n, r) {
                                var o = t instanceof R,
                                    a = this._bitField,
                                    c = 0 != (134217728 & a);
                                0 != (65536 & a) ? (o && t._invokeInternalOnCancel(), n instanceof F && n.isFinallyHandler() ? (n.cancelPromise = t, P(e).call(n, r) === O && t._reject(O.e)) : e === i ? t._fulfill(i.call(n)) : n instanceof s ? n._promiseCancelled(t) : o || t instanceof C ? t._cancel() : n.cancel()) : "function" == typeof e ? o ? (c && t._setAsyncGuaranteed(), this._settlePromiseFromHandler(e, n, r, t)) : e.call(n, r, t) : n instanceof s ? n._isResolved() || (0 != (33554432 & a) ? n._promiseFulfilled(r, t) : n._promiseRejected(r, t)) : o && (c && t._setAsyncGuaranteed(), 0 != (33554432 & a) ? t._fulfill(r) : t._reject(r))
                            }, R.prototype._settlePromiseLateCancellationObserver = function(t) {
                                var e = t.handler,
                                    n = t.promise,
                                    r = t.receiver,
                                    i = t.value;
                                "function" == typeof e ? n instanceof R ? this._settlePromiseFromHandler(e, r, i, n) : e.call(r, i, n) : n instanceof R && n._reject(i)
                                ...
                                var e = this._bitField;
                                if (!((117506048 & e) >>> 16)) {
                                    if (this._setRejected(), this._fulfillmentHandler0 = t, this._isFinal()) return y.fatalError(t, c.isNode);
                            ...
                            }, "undefined" != typeof Symbol && Symbol.toStringTag && d.defineProperty(R.prototype, Symbol.toStringTag, {
                                get: function() {
                                    return "Object"
                                }
                            }), R.defer = R.pending = function() {
                                return j.deprecated("Promise.defer", "new Promise"), {
                                    promise: new R(b),
                                    resolve: B,
                                    reject: I
                                }
                            }, c.notEnumerableProp(R, "_makeSelfResolutionError", r), t("./method")(R, b, E, o, j), t("./bind")(R, b, E, j), t("./cancel")(R, C, o, j), t("./direct_resolve")(R), t("./synchronous_inspection")(R), t("./join")(R, C, E, b, y), R.Promise = R, R.version = "3.7.2", t("./call_get.js")(R), t("./generators.js")(R, o, b, E, s, j), t("./map.js")(R, C, o, E, b, j), t("./nodeify.js")(R), t("./promisify.js")(R, b), t("./props.js")(R, C, E, o), t("./race.js")(R, b, E, o), t("./reduce.js")(R, C, o, E, b, j), t("./settle.js")(R, C, j), t("./some.js")(R, C, o), t("./timers.js")(R, b, j), t("./using.js")(R, o, E, A, b, j), t("./any.js")(R), t("./each.js")(R, b), t("./filter.js")(R, b), c.toFastProperties(R), c.toFastProperties(R.prototype), M({
                                a: 1
                            }), M({
                                b: 2
                            }), M({
                                c: 3
                            }), M(1), M((function() {})), M(void 0), M(!1), M(new R(b)), j.setBounds(v.firstLineError, c.lastLineError), R
                        }
                    }, {
                        "./any.js": 1,
                        "./async": 2,
                    ...
                    24: [function(t, e, n) {
                        ...
                        e.exports = function(e, n) {
                            ...
                            var g = c ? void 0 : function(t, c, l, u, f, p) {
                                var h = function() {
                                        return this
                                    }(),
                                    d = t;
                            ...
                            function m(t, e, n, o, s) {
                                for (var a = new RegExp(e.replace(/([$])/, "\\$") + "$"), c = y(t, e, a, n), l = 0, u = c.length; l < u; l += 2) {
                                    var f = c[l],
                                        p = c[l + 1],
                                        h = f + e;
                            ...
                            e.promisify = function(t, e) {
                                ...
                                var s = e.promisifier;
                                if ("function" != typeof s && (s = g), !i.isIdentifier(r)) throw new RangeError("suffix must be a valid identifier\n\n    See https://goo.gl/MqrFmX\n");
                    ...
                    27: [function(t, e, n) {
                        ...
                        e.exports = function(e, n, r, i) {
                            ...
                            function s(t, a) {
                                ...
                                for (var f = u._fulfill, p = u._reject, h = 0, d = t.length; h < d; ++h) {
                                    var v = t[h];
                                    (void 0 !== v || h in t) && e.cast(v)._then(f, p, void 0, u, null)
                                }
                                return u
                            }
                            e.race = function(t) {
                            ...
                            a.inherits(l, n), l.prototype._gotAccum = function(t) {
                                ...
                                if (!n.isRejected())
                                    for (; r < i; ++r) {
                                        ...
                                        n = n._then(p, void 0, void 0, a, void 0), 0 == (127 & r) && n._setNoAsyncGuarantee()
                                    }
                    ...
                    29: [function(t, i, o) {
                        ...
                        } else s = "undefined" == typeof MutationObserver || "undefined" != typeof window && window.navigator && (window.navigator.standalone || window.cordova) || !("classList" in document.documentElement) ? void 0 !== r ? function(t) {
                            r(t)
                        } : "undefined" != typeof setTimeout ? function(t) {
                            setTimeout(t, 0)
                        } : function() {
                            throw new Error("No async scheduler available\n\n    See https://goo.gl/MqrFmX\n")
                        } : (a = document.createElement("div"), c = {
                            attributes: !0
                            ...
                            return function(t, a) {
                                if (o(t)) {
                                    ...
                                    if ("function" == typeof c) return function(t) {
                                        ...
                                        var l = r.tryCatch(o).call(t, (function(t) {
                                            a && (a._resolveCallback(t), a = null)
                                        }), (function(t) {
                                            a && (a._rejectCallback(t, !1, !0), a = null)
                                        }));
                                        return a && l === i && (a._rejectCallback(l.e, !0, !0), a = null), c
                                    }(t, c, a)
                                }
                                return t
                            }
                    ...
                    36: [function(t, r, i) {
                        ...
                        function D() {
                            if ("function" == typeof Promise) try {
                                if ("[object Promise]" === R(new Promise((function() {})))) return Promise
                            } catch (t) {}
                        }

                        function V(t, e) {
                            if (null === t || "function" != typeof e || e === Q) return e;
                        ...
                        var N = {
                            ...
                            G;
                        N.isRecentNode = N.isNode && (e.versions && e.versions.node ? G = e.versions.node.split(".").map(Number) : e.version && (G = e.version.split(".").map(Number)), 0 === G[0] && G[1] > 10 || G[0] > 0), N.nodeSupportsAsyncResource = N.isNode && function() {
                            var e = !1;
                            try {
        ...
        var r = function(t) {
            ...
            return p.prototype = g.constructor = h, h.constructor = p, p.displayName = a(h, s, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
                var e = "function" == typeof t && t.constructor;
                return !!e && (e === p || "GeneratorFunction" === (e.displayName || e.name))
            }, t.mark = function(t) {
                return Object.setPrototypeOf ? Object.setPrototypeOf(t, h) : (t.__proto__ = h, a(t, s, "GeneratorFunction")), t.prototype = Object.create(g), t
            }, t.awrap = function(t) {
                return {
                    __await: t
                }
            ...
            }, m(g), a(g, s, "Generator"), g[i] = function() {
                return this
            }, g.toString = function() {
        ...
        "document" in window.self && ((!("classList" in document.createElement("_")) || document.createElementNS && !("classList" in document.createElementNS("https://www.w3.org/2000/svg", "g"))) && function(t) {
            "use strict";
            if ("Element" in t) {
            ...
            e.prototype.split_blocks = function(t, e) {
                ...
                block: {
                    ...
                    lists: function() {
                        ...
                        function i(t, e) {
                            for (var r = new RegExp("^(" + n + "{" + t + "}.*?\\n?)*$"), i = new RegExp("^" + n + "{" + t + "}", "gm"), s = []; e.length > 0 && r.exec(e[0]);) {
                                var a = e.shift(),
                                    c = a.replace(i, "");
                        ...
                        return function(o, a) {
                            var c = o.match(e);
                            if (c) {
                                for (var u, f, p, h = [], d = F(c), v = !1, y = [h[0].list];;) {
                                    for (var g = o.split(/(?=\n)/), m = "", _ = 0; _ < g.length; _++) {
                                        var b = "",
                                            w = g[_].replace(/^\n/, (function(t) {
                                                return b = t, ""
                                            })),
                                            k = (p = h.length, new RegExp("(?:^(" + n + "{0," + p + "} {0,3})([*+-]|\\d+\\.)\\s+)|(^" + n + "{0," + (p - 1) + "}[ ]{0,4})"));
                                        if (void 0 !== (c = w.match(k))[1]) {
                                            m.length && (r(u, v, this.processInline(m), b), v = !1, m = ""), c[1] = c[1].replace(/ {0,3}\t/g, "    ");
                                            var E = Math.floor(c[1].length / 4) + 1;
                                            if (E > h.length) d = F(c), u.push(d), u = d[1] = ["listitem"];
                                            else {
                                                var C = !1;
                                                for (f = 0; f < h.length; f++)
                                                    if (h[f].indent == c[1]) {
                                                        d = h[f].list, h.splice(f + 1, h.length - (f + 1)), C = !0;
                                                        break
                                                    } C || (++E <= h.length ? (h.splice(E, h.length - E), d = h[E - 1].list) : (d = F(c), u.push(d))), u = ["listitem"], d.push(u)
                                            }
                                            b = ""
                                        }
                                        w.length > c[0].length && (m += b + w.substr(c[0].length))
                                    }
                                    m.length && (r(u, v, this.processInline(m), b), v = !1, m = "");
                                    var x = i(h.length, a);
                                    x.length > 0 && (l(h, s, this), u.push.apply(u, this.toTree(x, [])));
                                    var A = a[0] && a[0].valueOf() || "";
                                    if (!A.match(e) && !A.match(/^ /)) break;
                                    o = a.shift();
                                    var j = this.dialect.block.horizRule(o, a);
                                    if (j) {
                                        y.push.apply(y, j);
                                        break
                                    }
        ...
        function h(t) {
            return function(t, e, n) {
                ...
                var n = e;
                return "https" !== e.slice(0, 4) && (n = "https://" + n), '<a href="' + n + '" target="_blank">' + e.replace("www.", "") + "</a>"
            }))
        }
        var d = "",
            v = {};
        ...
        function y(t, e, n) {
            var r = v[t.id];
            r || (r = v[t.id] = t.innerHTML), r = x(r, e), t.innerHTML = v[t.id] = r, d += e, ";" === e && (n.textContent += d, d = "")
        }
        ...
        function x(t, e) {
            return m && "/" !== e ? t += e : "/" === e && !1 === m ? (m = !0, t += e) : "/" === e && "*" === t.slice(-1) && !0 === m ? (m = !1, t = t.replace(_, '<span class="comment">$1/</span>')) : ":" === e ? t = t.replace(b, '<span class="key">$1</span>:') : ";" === e ? t = t.replace(w, '<span class="value">$1</span>;') : "{" === e ? t = t.replace(k, '<span class="selector">$1</span>{') : "x" === e && E.test(t.slice(-2)) ? t = t.replace(C, '<span class="value px">px</span>') : t += e, t
        }
        var A, j, F, T, S, O, P, R = n.n(l).a.markdown.toHTML,
            B = [0, 1, 2, 3].map((function(t) {
                return n(14)("./styles" + t + ".css").default
            })),
            I = "localhost" === window.location.hostname ? 0 : 16,
            M = !1,
            L = !1,
            H = !1;

        function Q() {
            return (Q = s()(i.a.mark((function t() {
                return i.a.wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return t.prev = 0, t.next = 3, J(j, B[0], 0, I, !0, 1);
                        case 3:
                            return t.next = 5, J(F, u, 0, I, !1, 1);
                        case 5:
                            return t.next = 7, J(j, B[1], 0, I, !0, 1);
                        case 7:
                            return K(), t.next = 10, c.a.delay(1e3);
                        case 10:
                            return t.next = 12, J(j, B[2], 0, I, !0, 1);
                        case 12:
                            return t.next = 14, J(T, f, 0, I, !1, 32);
                        case 14:
                            return t.next = 16, J(j, B[3], 0, I, !0, 1);
                        case 16:
                            t.next = 25;
                            break;
                        case 18:
        ...
        function D() {
            return (D = s()(i.a.mark((function t() {
                var e, n, r, o;
                return i.a.wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                        ...
                        case 2:
                            for (L = !0, T.innerHTML = f, e = B.join("\n"), A.textContent = "#work-text * { " + P + "transition: none; }", A.textContent += e, n = "", r = 0; r < e.length; r++) n = x(n, e[r]);
                            j.innerHTML = n, K(), o = Date.now();
                        case 12:
                            if (!(Date.now() - 1e3 > o)) {
                                t.next = 19;
                                break
                            }
                            return F.scrollTop = 1 / 0, j.scrollTop = T.scrollTop = 1 / 0, t.next = 17, c.a.delay(16);
                        case 17:
                            t.next = 12;
                            break;
                        case 19:
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            P = function() {
                ...
                })), document.getElementById("header").innerHTML = '<a href="#" id="pause-resume">Pause </a>\n<a href="#" id="skip-animation"></a>\n\n</span>\n', (t = document.createElement("style")).textContent = "/* I'm cheating a bit */\n\nhtml, body {\n  margin-top: 0;\n  height: 100%;\n  overflow: hidden;\n}\n\npre {\n  overflow: auto;\n  max-height: 90%;\n  width: 100%;\n  border-radius: 1px; /* Prevents bad clipping in Chrome */\n}\n\n#content {\n  position: absolute;\n  top: 0; right: 0; left: 0; bottom: 20px;\n}\n\n#header {\n  position: absolute;\n  bottom: 0;\n  height: 20px;\n  left: 0;\n  right: 0;\n  padding: 0 10px;\n}\n\na:after {\n  content: '';\n  padding-right: 5px;\n  border-right-width: 1px;\n  border-right-style: solid;\n  border-color: inherit;\n}\n\na:last-of-type:after {\n  border: none;\n}\n", document.head.insertBefore(t, document.getElementsByTagName("style")[0]), A = document.getElementById("style-tag"), j = document.getElementById("style-text"), F = document.getElementById("work-text"), T = document.getElementById("pgp-text"), O = document.getElementById("pause-resume"), j.addEventListener("input", (function() {
                    A.textContent = j.textContent
                })), O.addEventListener("click", (function(t) {
                    t.preventDefault(), H ? (O.textContent = "Pause ||", H = !1) : (O.textContent = "Resume >>", H = !0)
                })),
                function() {
        ...
        function U() {
            return (U = s()(i.a.mark((function t(e, n, r, o, s, a) {
                var l, u, f;
                return i.a.wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                        ...
                        case 2:
                            if (l = n.slice(r, r + a), r += a, e.scrollTop = e.scrollHeight, s ? y(e, l, A) : g(e, l), !(r < n.length)) {
                                t.next = 16;
                                break
                            }
                            u = o, f = n.slice(r - 2, r + 1), N.test(f) && (u = 30 * o), G.test(f) && (u = 50 * o), V.test(f) && (u = 70 * o);
                        case 12:
                        ...
                        case 14:
                            ...
                            case 15:
                                return t.abrupt("return", J(e, n, r, o, s, a));
                            case 16:
                            case "end":
                                return t.stop()
                    }
        ...
        function K() {
            if (!F.classList.contains("flipped")) {
                F.innerHTML = '<div class="text">' + h(u) + '</div><div class="md">' + h(R(u)) + "<div>", F.classList.add("flipped"), F.scrollTop = 9999;
                var t = 0;
                n(19)(F, function() {
                    var e = s()(i.a.mark((function e(n, r) {
                        ...
                        return i.a.wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                ...
                                case 2:
                                    if (o = F.classList.contains("flipped"), s = (F.scrollHeight - F.clientHeight) / 2, !(o ? F.scrollTop < s : F.scrollTop > s)) {
                                        e.next = 12;
                                        break
                                    }
                                    return F.classList.toggle("flipped"), t = !0, e.next = 10, c.a.delay(500);
                                case 10:
                                    F.scrollTop = o ? 0 : 9999, t = !1;
                                case 12:
                                    F.scrollTop += r * (o ? -1 : 1);
                                case 13:
                                case "end":
